...
class BotHandler:
    ...
    def setup_handlers(self):
        ...
        self.router.message.register(self.send_welcome, Command('start'))
        self.router.message.register(self.help_message, Command('help'))
        self.router.message.register(self.view_metrics, Command('metrics'))
        self.router.message.register(self.add_apartment_start, Command('addapartment'))
        self.router.message.register(self.apartment_name_entered, AddApartment.waiting_for_apartment_name)
        self.router.message.register(self.apartment_address_entered, AddApartment.waiting_for_apartment_address)
        self.router.message.register(self.add_metrics_start, Command('addmetrics'))
        self.router.message.register(self.metrics_entered, AddMetrics.waiting_for_metrics)
        self.router.message.register(self.add_user_start, Command('adduser'))
        self.router.message.register(self.user_entered, AddUser.waiting_for_user_name)
        self.router.message.register(self.handle_admin_response)
    ...
    async def handle_admin_response(self, message: Message):
